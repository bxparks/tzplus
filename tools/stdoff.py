...
Print a list of (zone, stdoff(int), stdoff(string)) in a file named
`stdoffs.txt` in the `--output_dir`. The `input_dir` contains the TZDB files
assumed to be generated by the `copytz.sh` which also contains a `version.txt`
file that indicates the TZDB version (e.g. "2023c").
...
from stdoffgenerator import STDOFF_FILE_NAME
...
def main() -> None:
    ...
    logging.info(f'==== Creating {STDOFF_FILE_NAME} file')
